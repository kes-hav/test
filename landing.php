...
<body>
    ...
    <div class="reveal bg-gray-100 rounded items-center justify-center" id="modal1" data-reveal>
        ...
        <div class="bg-gray-100 flex rounded-2xl  max-w-3xl items-center flex justify-center">
            ...
            <div class="md:w-full px-8 md:px-16">
                ...
                <form action="login.php" class="flex flex-col gap-4" method="post" target="_self" id="login">
                    <span id="error">
                    </span>
                    <input autofocus class=" p-2 mt-8 rounded-xl border" type="text" name="user_name" id="username1"
                    ...
                    <button name="submitLogin" id="loginbtn"
                ...
                <button onclick="window.location = '<?php echo $loginURL ?>';" class=" bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm
    ...
    <div class="reveal bg-gray-100 rounded items-center justify-center" id="modal2" data-reveal>
        <div class="bg-gray-100 flex rounded-2xl  max-w-3xl items-center flex justify-center">
            ...
            <div class="md:w-full px-8 md:px-16">
                ...
                let btnClear2 = document.querySelector('#cbtn2');
                ...
                <form action="register.php" class="flex flex-col gap-4 " method="post" target="_self">
                    <div>
                        <input class="p-2 mt-8 rounded-xl border" type="text" name="user_name" placeholder="Username"
                            id="username" onInput="checkUsername()" required autofocus>
                        <span id="check-username"> </span>
                    </div>
                    <div class="relative ">
                        <input class="p-2 rounded-xl border w-full " type="tel" name="phonenumber"
                            placeholder="Mobile Number" pattern="[5]{1}[0-9]{7}"
                            title="Mobile Number should start with 5 and consist of 8 digits" required>


                    </div>
                    <div class="relative">
                        <input class="p-2 rounded-xl border w-full" type="password" name="reg_password"
                    ...
                    <button class=" bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300 " id="register"
                        name="submitRegister" disabled>Register</button>
                </form>
    ...
    <!-- Hero Section -->
    <div class=" reveal bg-gray-100 rounded items-center justify-center" id="modal3" data-reveal>
        <!-- <section class="bg-gray-100 rounded-md flex items-center justify-center z-50 lg-shadow"> -->
        <!-- login container -->
        <div class="bg-gray-100 flex rounded-2xl  max-w-3xl items-center flex justify-center">
            ...
            <!-- form -->
            <div class="md:w-full px-8 md:px-16">
                <button class="text-gray-500 text-xl" data-close type="button ">
                    <span aria-hidden=" true " data-open=" modal1 ">
                        &#9664;</span>
                </button>
                <div class=" flex justify-between">
                    <div>
                ...
                <form action="#" class="flex flex-col gap-4" method="post" target="_self" id="login">
                    <input autofocus class="p-2 mt-8 rounded-xl border" type="text" name="username"
                        placeholder="Username" required>
                    <div class="text-xs flex justify-between items-center text-[#002D74]">
                        <p>Password will be sent to your mobile number!</p>
                    </div>
        ...
        <button class="close-button" data-close type="button" id="cbtn2">
            <span aria-hidden="true">×</span>
        </button>
    </div>
    <script>
    $("#login").submit(function(e) {
        ...
        var dataString = 'username1=' + username1 + '&password=' + password;
        $.ajax({
            type: "POST",
            url: "login.php",
            data: dataString,
            ...
            success: function(data) {
                ...
                if (data == "user") {
                    ...
                    $("#error").html(
                        "<span style='color:#cc0000'>Error:Invalid username and password.</span>  "
                    );
                $("#loginbtn").val('Submit')
